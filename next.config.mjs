        ...
        headers: [
          {
            ...
            value: [
              ...
              "frame-src https://googleads.g.doubleclick.net https://tpc.googlesyndication.com https://pagead2.googlesyndication.com https://www.google.com https://www.youtube.com",
              "connect-src 'self' https://www.google-analytics.com https://region1.google-analytics.com https://*.upstash.io https://www.googletagmanager.com https://pagead2.googlesyndication.com",
              "form-action 'self'",
              "base-uri 'self'",
              "object-src 'none'",
            ].join('; '),
