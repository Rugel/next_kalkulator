...
export default function FloatingCalculator() {
  ...
  return (
    ...
    >
        {isOpen ? (
          <svg xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Zamknij kalkulator" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <title>Zamknij kalkulator</title>
            <line x1="18" y1="6" x2="6" y2="18"></line>
            <line x1="6" y1="6" x2="18" y2="18"></line>
          </svg>
        ) : (
          <svg xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Otwórz kalkulator" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <title>Otwórz kalkulator</title>
